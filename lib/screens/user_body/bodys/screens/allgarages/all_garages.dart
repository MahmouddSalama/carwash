...
import 'package:carwash/screens/user_body/bodys/screens/allgarages/all_garage_dateals.dart';
...
class AllGarages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('All Garages',style: TextStyle(
            color: Colors.black
        ),),
      ),
      body: Center(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, index) {
                      return GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (ctx)=>AllGarageDetailes(
